...
#define EXCEPTION_INVALID_CHAR 8
#define EXCEPTION_CAST_TO_SYMBOL_FAILED 9
#define EXCEPTION_CAST_TO_KEYWORD_FAILED 10
#define EXCEPTION_SYMBOL_ALREADY_DEFINED 11
#define EXCEPTION_ILLEGAL_ACTION 12
